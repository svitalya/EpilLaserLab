...
namespace EpilLaserLab.Server.Migrations
{
    ...
    [Migration("20240414142247_CreateServices")]
            ...
            modelBuilder.Entity("EpilLaserLab.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Login = "Admin",
                            PasswordHash = "$2a$11$6cCIE/0J7JYy0bYYxkLPi.ofLiLRtL8COVVohKIsnfm1nRJWbieeW",
                            RoleId = 1
                        },
                        new
                        {
                            UserId = 2,
                            Login = "User",
                            PasswordHash = "$2a$11$6s8eF1nQ6CdaIu/6dp8Ltu/IrbfQrqZVeGY6nab8oIy9iXWDBdCm.",
                            RoleId = 2
                        });
                });
