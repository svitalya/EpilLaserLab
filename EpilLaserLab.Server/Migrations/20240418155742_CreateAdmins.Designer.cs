...
namespace EpilLaserLab.Server.Migrations
{
    ...
    [Migration("20240418155742_CreateAdmins")]
            ...
            modelBuilder.Entity("EpilLaserLab.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Login = "Admin",
                            PasswordHash = "$2a$11$RBUy8irkIh.mbEwkiz4JNezFxKOO/P7uuVhaMk.9lWoUN7zzsvm.2",
                            RoleId = 1
                        },
                        new
                        {
                            UserId = 2,
                            Login = "User",
                            PasswordHash = "$2a$11$r8s1E7sLsXbBIuFFU2XHFeR5zChRtRXBFelClYumlw6q0P.Rrhwau",
                            RoleId = 2
                        });
                });
