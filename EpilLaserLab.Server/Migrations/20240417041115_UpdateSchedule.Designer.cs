...
namespace EpilLaserLab.Server.Migrations
{
    ...
    [Migration("20240417041115_UpdateSchedule")]
            ...
            modelBuilder.Entity("EpilLaserLab.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Login = "Admin",
                            PasswordHash = "$2a$11$JXzI1Yk/k.EinQ04j0zqMemWqs4HanYeVO7wLckdu3BIDS1osvGWm",
                            RoleId = 1
                        },
                        new
                        {
                            UserId = 2,
                            Login = "User",
                            PasswordHash = "$2a$11$t82vqNtHAvczyDmc336BvufzCFRJ9FArCNapYRuAAwfW6HSj7jN2S",
                            RoleId = 2
                        });
                });
