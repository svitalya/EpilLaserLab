...
namespace EpilLaserLab.Server.Migrations
{
    ...
    [Migration("20240417081719_CreateClients")]
            ...
            modelBuilder.Entity("EpilLaserLab.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Login = "Admin",
                            PasswordHash = "$2a$11$xSKKzX7PuUkXGsVZ944NXehnbdzAZyQs0luuQe4ntCt7M5UV34lQu",
                            RoleId = 1
                        },
                        new
                        {
                            UserId = 2,
                            Login = "User",
                            PasswordHash = "$2a$11$SDpy7Gr9AtO8BIiEOwyvpup8gHBiZbC4gyCSvW3qRJqcSkJwdDbtm",
                            RoleId = 2
                        });
                });
