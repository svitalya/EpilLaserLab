...
namespace EpilLaserLab.Server.Migrations
{
    ...
    [Migration("20240417061733_CreateIntervals")]
    partial class CreateIntervals
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EpilLaserLab.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Login = "Admin",
                            PasswordHash = "$2a$11$Q.rgaI7yqtxIwQg60XRzk./k2qSX02UTEWBKup04ibtP5QJzReB2S",
                            RoleId = 1
                        },
                        new
                        {
                            UserId = 2,
                            Login = "User",
                            PasswordHash = "$2a$11$gH1OZ.RtegwMYLQrfS2tXuGgShRC/G57hWF5cFVvLVdXVdxkiH.9i",
                            RoleId = 2
                        });
                });
