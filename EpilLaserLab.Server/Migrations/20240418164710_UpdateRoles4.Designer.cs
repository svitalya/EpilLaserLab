...
namespace EpilLaserLab.Server.Migrations
{
    ...
    [Migration("20240418164710_UpdateRoles4")]
            ...
            modelBuilder.Entity("EpilLaserLab.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Login = "Admin",
                            PasswordHash = "$2a$11$lXT5Lthl7bqUomEi8qI.Ku6ZiHWOT3X.xxqMWi9OuNHsAhtxEQibq",
                            RoleId = 1
                        },
                        new
                        {
                            UserId = 2,
                            Login = "User",
                            PasswordHash = "$2a$11$RGalnQiIxBsjPnyoVha0cezIbwMvmrFbIDPhTHGORla.0n8WsbEKu",
                            RoleId = 2
                        });
                });
