        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelAccess = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 4294967295u, "Админ" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Email", "Login", "PasswordHash", "RoleId" },
                values: new object[] { 1, null, "Admin", "$2a$11$YUETMr69/ntB1q9YPyDu5.jIXCftQ4.3GSYhFVFJLM0ogwHJoEq5K", 1 });
