<template>
    ...
    <form @submit.prevent="submitForm" class="row mt-3">
      <div class = "col-3">
        ...
        <div class="row form-group mt-3">
          <img width = "300px" height = "300px" :src="imageSrc" id="image">
  ...
  export default defineComponent({
    ...
    async beforeCreate() {
      ...
      await fetch(`/api/masters/${this.id}`,{
          ...
          if(responceJson.message == "OK"){
            ...
            this.data.branchId = rec.branchId;

            this.data.employee.surname = rec.employee.surname;
            this.data.employee.name = rec.employee.name;
    ...
    setup(){
      ...
      let imageSrc = ref("https://imgholder.ru/300X300/8493a8/adb9ca&font=kelson");
