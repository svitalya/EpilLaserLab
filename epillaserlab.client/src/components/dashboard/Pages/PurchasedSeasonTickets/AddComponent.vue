...
export default defineComponent({
  mounted(){
    ...
    fetch('/api/prices/subsciptions-list', {
      method: "GET",
      credentials: "include",
      headers: {'Content-Type': "application/json"}
    }).then(async responce => {
      ...
      this.data.seasonTicketPriceId = recs[0].seasonTicketPriceId
    })
  },
  setup(){
    ...
    const submitForm = async (e) => {
        ...
        await fetch(`/api/purchasedseasontickets`, {
          method: "POST",
          headers: {'Content-Type': "application/json"},
          credentials: "include",
    ...
    return {clientSelected, plusMinusBtnClickHandler, clientsData, data, seasonTickets, submitForm}
  }
